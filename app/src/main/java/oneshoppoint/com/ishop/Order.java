...
public class Order extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        card.prescriptionCode = MyShortcuts.getDefaults("carriername", this)+" total is Ksh. "+MyShortcuts.getDefaults("carriertotal", this);
    ...
    private void PostOrder() {
        ...
        JsonObjectRequest req = new JsonObjectRequest(Request.Method.POST, "https://www.oneshoppoint.com/api/checkout/order/", customer,
