...
//                            startActivity(intent);
    ...
    private void storecustomer() {
        ...
        try {
            ...
            js.put("carrierPlan", MyShortcuts.getDefaults("planname", this));
            js.put("retailerId", MyShortcuts.getDefaults("retailerid", this));

            if (MyShortcuts.getDefaults("carrierservice", this).equals("true")) {
                js.put("carrierTransactionCode", MyShortcuts.getDefaults("carriercode", this));
                js.put("carrierId", MyShortcuts.getDefaults("carrierId", this));
            }
