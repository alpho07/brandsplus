                            ...
                            for (int i = 0; i < res.length(); i++) {
                                ...
                                if (c.getString("id").equals(ID)) {
                                    ...
                                    for (int j = 0; j < children1.length(); j++) {
                                        ...
                                        items.setThumbnailUrl("https://www.oneshoppoint.com/images" + e.getString("path"));
                                        items.setTheID(d.getString("id"));
                                        items.setTitle(d.getString("name"));
                                        itemsList.add(items);
                                        Log.e("CategoryFragment", d.getString("name"));
...
//
                            adapter = new SubCategoryAdapter(getBaseContext(), itemsList);
